...
public static boolean targetMissileActive = false;
  ...
  public static int shooterHitCount;
   ...
   public static void drawAll(Graphics g) {
      ...
      String hitDisplayString = "Hits: ";
      for (int i=0;i<hitCount;i++)
         hitDisplayString = hitDisplayString + "*";
      for (int i = 0; i<shooterHitCount; i++);
      hitDisplayString = hitDisplayString + "!";
...
targetMissileDeltaY = TARGET_SIZE/2;
   ...
   public static void moveTargetMissile(Graphics g){
    if (!targetMissileActive)
      ...
      if (missileActive && detectHitShooter()) {
         drawMissile(g,BACKGROUND_COLOR);
         missileActive = true;
         targetHitTimer = HIT_TIMER_MAX;
   ...
   public static boolean detectHitShooter() {
   ...
   public static double triangleX(angle, TARGET_SIZE/2) {
